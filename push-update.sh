...
updates_dir=/data/creative_updates

if [ ! -f "$1" ]; then
   echo "Usage: $0 ZIP [UNVERIFIED]"
   echo "Push ZIP to $updates_dir and add it to Updater"
   echo
   echo "The name of ZIP is assumed to have creative-VERSION-DATE-TYPE-* as format"
...
adb shell "killall com.creative.updater 2>/dev/null"
adb shell "sqlite3 /data/data/com.creative.updater/databases/updates.db" \
