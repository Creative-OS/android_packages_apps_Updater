...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "org.creative.version";
    public static final String PROP_DEVICE = "ro.creative.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "creative.updater.allow_downgrading";
